...
const courses = ref([
    ...
    },
    {
        ...
        description: ["Помогу подтянуть проблемные темы, почувствовать себя увереннее на уроках английского языка в школе. Мои уроки строятся на четырех китах успешного английского – постановка произношения, расширение словаря, грамотное написание слов и конечно осознанное использование грамматики (с каждым ребенком мы создаем его личную Grammar BOOK). На уроках мы: Отрабатываем технику чтения и понимая текстов; учимся излагать информацию в письменном виде; оттачиваем навык понимать речь на слух; развиваем разговорную речь. Я стремлюсь подавать материал через интересные и актуальные для подростков темы."],
        price: "900 р",
        time: "50 мин",
        packetPrice: "4000 р",
        packetTime: "5 занятий",
